...
#define create_bank_account_ExpectAndReturn(cmock_retval) TEST_FAIL_MESSAGE("create_bank_account requires _Expect (not AndReturn)");
#define create_bank_account_Expect() create_bank_account_CMockExpect(__LINE__)
