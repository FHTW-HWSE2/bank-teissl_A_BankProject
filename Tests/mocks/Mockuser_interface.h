...
#define get_nonempty_input_ExpectAndReturn(prompt, buffer, size, cmock_retval) TEST_FAIL_MESSAGE("get_nonempty_input requires _Expect (not AndReturn)");
#define get_nonempty_input_Expect(prompt, buffer, size) get_nonempty_input_CMockExpect(__LINE__, prompt, buffer, size)
