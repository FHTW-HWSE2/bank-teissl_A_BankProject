...
void CMockExpectParameters_get_nonempty_input(CMOCK_get_nonempty_input_CALL_INSTANCE* cmock_call_instance, const char* prompt, char* buffer);
void CMockExpectParameters_get_nonempty_input(CMOCK_get_nonempty_input_CALL_INSTANCE* cmock_call_instance, const char* prompt, char* buffer)
{
...
void get_nonempty_input_CMockExpect(UNITY_LINE_TYPE cmock_line, const char* prompt, char* buffer)
{
  ...
  Mock.get_nonempty_input_IgnoreBool = (char)0;
  cmock_call_instance->LineNumber = cmock_line;
  CMockExpectParameters_get_nonempty_input(cmock_call_instance, prompt, buffer);
}
